...
$(document).ready(function() {
  ...
  $('.submit-tweet').submit(function(event) {
    ...
    if(formData.length - 5 > 140 || formData.length - 5 === 0) {
      let errorMessage = formData.length - 5 > 140 ? 'Too many characters' : 'Please add characters to submit a tweet';
      $('.submit-tweet').append(`<p>${errorMessage}</p>`);
    } else {
